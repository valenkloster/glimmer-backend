const buildMail = (recoveryUrl) => {
  ...
  */
                                                                  ...
                                                                  <tr>
                                                                      <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                          <table cellpadding="0" cellspacing="0" width="100%">
                                                                              <tbody>
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px;"><a target="_blank"><img src="https://i.imgur.com/ypEhzYA.png" alt style="display: block;" width="270"></a></td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                  ...
                                                                                  <tr>
                                                                                      <td align="left" class="esd-block-text es-p10t">
                                                                                          ...
                                                                                          <ol>
                                                                                              ...
                                                                                              <li>Haga clic en Enviar.<br><br></li>
                                                                                          </ol>
                                                                                      </td>
                                                                                  </tr>
                                                                              </tbody>
  ...
  <![endif]-->
                                                                                          <!--[if !mso]><!-- --><span class="msohide es-button-border" style="border-radius: 6px; background: #5ea793;"><a href="${recoveryUrl}" class="es-button" target="_blank" style="padding-left: 30px; padding-right: 30px; border-radius: 6px; background: #5ea793; border-color: #5ea793">CAMBIAR CONTRASEÑA</a></span>
                                                                                          <!--<![endif]-->
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-text es-p10t es-m-txt-c">
                                                                                          <h3 style="line-height: 150%; font-size: 17px;"><br>Este enlace es válido para un solo uso. Caduca en 15 minutos.</h3>
                                                                                      </td>
                                                                                  </tr>
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-text es-p10t es-p10b">
                                                                                          <p style="line-height: 150%;"><br>Si no solicitó restablecer su contraseña, ignore este mensaje o comuníquese con nuestro departamento de servicio al cliente.</p>
                                                                                      </td>
                                                                                  </tr>
                                                                              </tbody>
                                                                          </table>
                                                                                  ...
                                                                                  <tr>
                                                                                      <td align="center" class="esd-block-social es-p15t es-p15b" style="font-size:0">
                                                                                          <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                                                                                              <tbody>
                                                                                                  <tr>
                                                                                                      <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Facebook" src="https://gdcuat.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32"></a></td>
                                                                                                      <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Instagram" src="https://gdcuat.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32"></a></td>
                                                                                                      <td align="center" valign="top"><a target="_blank" href><img title="Youtube" src="https://gdcuat.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32"></a></td>
                                                                                                  </tr>
                                                                                              </tbody>
                                                                                          </table>
                                                                                      </td>
