...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-text-9810 es-p10">
                                              <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                Hemos recibido tu pedido y está siendo procesado con mucho cuidado. ✨
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" class="esd-block-text es-text-1143 es-p10">
                                              <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                Te mantendremos informado sobre el estado del mismo. Puedes ver el detalle completo iniciando sesión en tu cuenta GLIMMER.
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
  ...
  <![endif]-->
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-m-txt-c es-p15">
                                              <h3 style="line-height: 150%; font-size: 17px">
                                                <strong style="color: #5ea793; font-family: &#39;playfair display&#39;,georgia,&#39;times new roman&#39;,serif">Gracias por confiar en nosotros para el cuidado de tu piel</strong>
                                              </h3>
                                            </td>
                                          </tr>
                                        </tbody>
