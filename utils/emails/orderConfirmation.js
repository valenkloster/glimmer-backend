  ...
  <body data-new-gr-c-s-loaded="14.1107.0">
    <div class="es-wrapper-color">
      <!--[if gte mso 9]>
          ...
          <![endif]-->
      <table cellspacing="0" width="100%" cellpadding="0" class="es-wrapper">
        <tbody>
          <tr>
            <td valign="top" class="esd-email-paddings">
              <table cellspacing="0" align="center" cellpadding="0" class="es-header esd-header-popover">
                <tbody>
                  <tr>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-text-9810 es-p10">
                                              <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                Hemos recibido tu pedido #${order.id_pedido} y está siendo procesado. <img src="https://emojiisland.com/cdn/shop/products/Sparkling_Pink_Heart_Emoji_large.png?v=1571606066" width="20" style="display: inline-block; vertical-align: middle">
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="left" class="esd-structure es-p20r es-p20l" style="background-color: #ffffff; padding: 20px">
                                              ${productsHTML} ${orderSummaryHTML}
                                              <table cellpadding="0" cellspacing="0" width="100%">
                                                <tbody></tbody>
                                              </table>
                                            </td>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-text-9810 es-p20">
                                              <p class="es-text-mobile-size-16" style="font-size: 16px; color: #5ea793">
                                                <strong>Gracias por confiar en nosotros para el cuidado de tu piel</strong>
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td valign="top" align="center" class="es-p40r">
                                                      <a href="" target="_blank">
                                                        <img title="Instagram" width="32" alt="Inst" src="https://gdcuat.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png">
                                                      </a>
                                                    </td>
