const buildOrderDeliveredMail = (orderId) => {
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-image es-p10b" style="font-size: 0px">
                                              <a href="" target="_blank">
                                                <img alt="Logo" src="https://i.imgur.com/tTTvwkS.png&quot;&quot;" title="Logo" width="200" style="font-size: 12px; display: block">
                                              </a>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text es-text-9810 es-p20">
                                              <p class="es-text-mobile-size-16" style="font-size: 16px; color: #5ea793">
                                                <strong>¡Es momento de disfrutar tus nuevos productos GLIMMER!</strong>
                                              </p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="left" class="esd-block-text es-text-1143 es-p10r es-p5b es-p10l es-p5t">
                                              ...
                                              <ul>
                                                <li class="es-text-mobile-size-16" style="font-size: 16px">
                                                  <p style="font-size: 16px">
                                                    Revisa que el empaque esté en perfectas condiciones
                                                  </p>
                                                </li>
                                                <li class="es-text-mobile-size-16" style="font-size: 16px">
                                                  <p style="font-size: 16px">
                                                    Lee las instrucciones de uso de cada producto
                                                  </p>
                                                </li>
                                                <li class="es-text-mobile-size-16" style="font-size: 16px">
                                                  <p style="font-size: 16px">
                                                ...
                                                <li class="es-text-mobile-size-16" style="font-size: 16px">
                                                  <p style="font-size: 16px">
                                                    Incorpora los productos gradualmente a tu rutina
                                                  </p>
                                                </li>
                                              </ul>
                                            </td>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px">
                                              <a target="_blank">
                                                <img alt="" src="https://i.imgur.com/QOjqt34.png" width="270" style="display: block">
                                              </a>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="center" class="esd-block-text es-text-5133 es-p20">
                                              <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                <strong>Nos encantaría conocer tu opinión. Una vez que hayas probado los productos, puedes compartir tu experiencia dejando una reseña en nuestra web.&nbsp;</strong><br>
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
...
export default buildOrderDeliveredMail;
