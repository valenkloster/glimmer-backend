  ...
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
                                            ...
                                            <tr>
                                              <td align="center" class="esd-block-image es-p10b" style="font-size: 0px">
                                                <a href="" target="_blank">
                                                  <img width="200" alt="Logo" src="https://i.imgur.com/tTTvwkS.png&quot;&quot;" title="Logo" style="font-size: 12px; display: block">
                                                </a>
                                              </td>
                                            </tr>
                                          </tbody>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px">
                                                <a target="_blank">
                                                  <img alt="" src="https://i.imgur.com/1nlGB2C.png" width="270" style="display: block">
                                                </a>
                                              </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              <td align="center" class="esd-block-text es-text-9810 es-p20">
                                                <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                  ¡Ya casi es tuyo! Solo unos pasos más y podrás disfrutar de tus productos GLIMMER.
                                                </p>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td align="left" class="esd-block-text es-text-1143 es-p10">
                                                <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                ...
                                                <ul>
                                                  ...
                                                  <li style="font-size: 16px">
                                                    <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                      Mantén tu teléfono cerca para cualquier actualización
                                                    </p>
                                                  </li>
                                                  <li style="font-size: 16px">
                                                    <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                      Revisa que la dirección de entrega proporcionada esté correcta
                                                    </p>
                                                  </li>
                                                </ul>
                                              </td>
                                            ...
                                            <tr>
                                              <td align="center" class="esd-block-text es-p10 es-text-5133">
                                                <p class="es-text-mobile-size-16" style="font-size: 16px">
                                                  Te notificaremos cuando tu pedido haya sido entregado. Mientras tanto, puedes ver el detalle completo iniciando sesión en tu cuenta GLIMMER.<br>
                                                </p>
                                              </td>
                                            </tr>
                                          </tbody>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td width="560" align="center" valign="top" class="esd-container-frame">
                                        <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse: separate; border-radius: 5px">
                                          <tbody>
                                            <tr>
                                              <td align="center" class="esd-block-button es-p20t es-p20b">
    ...
    <![endif]-->
                                                ...
                                                <span class="msohide es-button-border" style="background: #5ea793; border-radius: 6px; border-color: #5ea793">
                                                  <a href="https://glimmerapp.tech/login" target="_blank" class="es-button" style="background: #5ea793; border-color: #5ea793; padding-left: 30px; padding-right: 30px; border-radius: 6px">
                                            ...
                                            <tr>
                                              <td align="center" class="esd-block-text es-m-txt-c es-p15 es-text-9626">
                                                <h3 class="es-text-mobile-size-18" style="line-height: 150%; font-size: 18px; color: #5ea793; font-family: &#39;playfair display&#39;,georgia,&#39;times new roman&#39;,serif">
                                                  <strong>Tu rutina de skincare está cada vez más cerca</strong>
                                                </h3>
                                              </td>
                                            </tr>
                                          </tbody>
